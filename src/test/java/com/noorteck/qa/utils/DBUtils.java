...
public class DBUtils extends Constants {
	...
	public static void connectToDB() {
		try {
			...
			envDataMap = JsonFileUtils.jsonToMap(filePath);

			// Create connection with database
			connection = DriverManager.getConnection(envDataMap.get("DBServerURL").toString(),
					envDataMap.get("DBUserName").toString(), envDataMap.get("DBPassword").toString());
			// connection =
			// DriverManager.getConnection("jdbc:mysql://hr-scrum.noortecktraining.com:8002","noorteck_hr_scrum_user","scrum_db123");
